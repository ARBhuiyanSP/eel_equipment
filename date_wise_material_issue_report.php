		...
		<div class="col-md-10" id="printableArea">
			<div class="row">
				...
				<table id="" class="table table-bordered">
					...
					$master_tables = " SELECT t1.id as master_id,'mCost' as type,t1.created_at,t1.remarks,p.code as p_code,p.project_name,inv_w.name as warehouse_name
...
while($masterRow=mysqli_fetch_array($master_tables_results))
{
	...
	$type  	= $masterRow['type'];
                            ...
                            WHERE 1=1 AND `warehouse_id`='$warehouse_id' AND mbtype='$type' AND mb_ref_id='$master_id'  ";
