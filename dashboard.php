		  ...
		  <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-info o-hidden h-100">
              <div class="card-body">
				...
				<?php $table    =   "equipments";
				$where    =   "WHERE `equipment_type`='Own'"; ?>
                <div class="mr-5"><?php echo getDataRowByConditions($table,$where); ?> Own Equipments</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="typewise_equipment_list_report.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
		  ...
		  <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-info o-hidden h-100">
              <div class="card-body">
				...
				<?php 
				$table    =   "equipments";
				$where    =   "WHERE `present_location_type`='Rental'";
				?>
                <div class="mr-5"><?php echo getDataRowByConditions($table,$where); ?> Equipments in Rental Project</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="rental_site_equipment_list_report.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
