...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i> Opening Stock Entry
            <a href="op-list.php" style="float:right"><i class="fas fa-list"></i> Opening Stock List<a>
		</div>
        <div class="card-body">
                ...
                <form action="" method="post" name="add_name" id="receive_entry_form" enctype="multipart/form-data" onsubmit="showFormIsProcessing('receive_entry_form');">
                    <div class="row" id="div1" style="">
                        <div class="col-xs-2">
                            <div class="form-group">
                                <label>OP Date</label>
                                <input type="text" autocomplete="off" name="op_date" id="mrr_date" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <?php 
                                        ...
                                        $mrrcode= 'OP-'.$short_name;
                                    
                                ?>
                                <input type="text" name="op_no" id="op_no" class="form-control" readonly="readonly" value="<?php echo getDefaultCategoryCodeByWarehouse('inv_op', 'op_no', '03d', '001', $mrrcode) ?>">
                            </div>
                        </div>
						<div class="col-xs-2">
							<div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <select class="form-control material_select_2" id="material_name" name="material_name[]" required onchange="getItemCodeByParam(this.value, 'inv_material', 'material_id_code', 'material_id0', 'qty_unit', 'part_no');">
                                                ...
                                                <?php
                                                $projectsData = get_op_product_with_category();
                    ...
                    <div class="row" style="">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                 <input type="submit" name="opening_submit" id="submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="Save" />   
                            </div>
                        </div>
                    </div>
                </form>
